    ...
    async adapter(binding) {
      ...
      return Object.freeze({ ...base,
        async open(taskId) {
          ...
          if (mutation === "swap-uncertain-states" || mutation === "conflate-uncertain-states") return Object.freeze({ ...projection, sections: { ...projection.sections, evidenceAndUncertainty: { ...projection.sections.evidenceAndUncertainty, uncertainConsequences: projection.sections.evidenceAndUncertainty.uncertainConsequences.map((consequence) => consequence.reservationId === "reservation_pending" ? { ...consequence, state: mutation === "swap-uncertain-states" ? "definitive-failure" : "reserved" } : consequence.reservationId === "reservation_failed" ? { ...consequence, state: "reserved" } : consequence) } } });
          return projection;
        },
