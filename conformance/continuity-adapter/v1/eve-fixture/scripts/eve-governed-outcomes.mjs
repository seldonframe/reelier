...
export async function runEveGovernedOutcomesV1(input){
  ...
  const appRoot=await stage(),events=[],sessionIds=[];let server;
  ...
  try{
    ...
    return Object.freeze({processRestarts:2,sessionIds:Object.freeze(sessionIds),toolCalls:Object.freeze(toolCalls),toolEvents:Object.freeze(toolEvents),messages:Object.freeze(messages)});
