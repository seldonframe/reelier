...
| `emit` | No (artifact attestation, 0.30.0+) | 0 or 1 | `"Duplicate 'emit' field in step"` |
...
`emit: {"projection":["args.<key>",...]}` (artifact attestation, 0.30.0+;
...
### 6.1e Pre-dispatch artifact attestation (`emit:`, 0.30.0+)
