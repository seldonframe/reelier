...
export interface CertifiedIdentityVerifier { readonly purpose: string; readonly verify: (input: Readonly<{ identityDigest: string; identity: AuthenticatedProviderIdentityV1; purpose: "authority-evidence" }>) => Promise<boolean> | boolean; }
