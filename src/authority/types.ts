...
export type AuthoritySignaturePurpose = AuthorityKind | "signed-job-card" | "authority-journal" | "authority-lease" | "release-evidence" | "certification-readiness" | "topology-evidence" | "job-reference";
