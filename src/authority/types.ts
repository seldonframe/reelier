export const authorityKinds = ["principal","delegation-grant","source-bundle","outcome-contract","outcome-request","transport-effect","tool-effect-contract","compiled-capability","decision-context","gate-event","authority-evidence","authority-receipt","pack-manifest"] as const;
export type AuthorityKind = (typeof authorityKinds)[number];
export type AuthoritySignaturePurpose = AuthorityKind | "signed-job-card" | "authority-journal" | "authority-lease" | "release-evidence" | "release-authorization" | "release-receipt" | "certification-readiness" | "topology-evidence" | "job-reference";
...
/** Additive provider-neutral governed-effect arm; TransportEffect remains the existing receipt ABI. */
export type GovernedEffect = TransportEffect | import("./tool-effect-contract.js").ToolEffectContractV1;
