...
function safeChoices(value: unknown): Readonly<Record<string, unknown>> { const raw = object(value, "certification desired choices"); rejectDangerous(raw, "choices"); return deepFreeze(structuredClone(raw)); }
