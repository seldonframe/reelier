...
const CELL_PURPOSES = ["authority-evidence", "authority-journal", "authority-lease", "authority-receipt", "delegation-grant", "gate-event", "outcome-contract", "topology-evidence"] as const;
