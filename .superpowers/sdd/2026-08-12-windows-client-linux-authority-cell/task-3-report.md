...
- Fix round 3: configuration metadata is explicitly non-authorizing. Native Windows same-user mutation resistance remains `unchecked`; no native-helper TCB was introduced.
