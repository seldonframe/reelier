...
test("public production export parses DecisionContext and its portable evidence against packaged schemas", async () => {
  ...
  assert.deepEqual(Object.keys(authority).sort(), ["assertAcceptedDecisionContext","authorityCanonicalBytes","authorityDigest","authorityEvidenceCanonicalBytes","authorityKinds","createAuthorityEvidence","createAuthorityReceipt","createAuthorityReceiptBundle","decisionContextPresence","digestAuthorityReceiptBundle","normalizeSignedJobCard","parseAuthorityReceiptBundle","parseAuthorityWire","parseCanonicalAuthorityJson","parsePortableAuthorityEvidence","signAuthorityDigest","signJobCard","signedJobCardDigest","verifyAuthorityReceipt","verifyAuthorityReceiptBundle","verifyAuthoritySignature","verifySignedJobCard"], "the public runtime export surface is an exact allowlist");
