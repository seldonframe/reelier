...
export function governedReceiptSigningFixture(now = verificationTime) {
  ...
  registerCertificationLifecycleTrustContext(material,{tenant:identifiers.authorityCellId,jobCardTrustPin:pin,expectedAuthorityCellId:identifiers.authorityCellId,expectedTaskId:identifiers.taskId,observedAt:now});
