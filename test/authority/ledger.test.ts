...
test("prep-only housekeeper routes stable authority without mutation",async t=>{
  const tokenPoint="prep-only-creator-token-carried",nonePoint="prep-only-no-authority",deadPoint="prep-only-prep-retirement-authority-dead-owner",authorityPoints=[tokenPoint,nonePoint,deadPoint] as const;
