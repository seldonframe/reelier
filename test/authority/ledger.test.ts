...
const publicationCollisionFaultPoints=[...publicationCrashPoints,"before-lock-publication-rename","after-active-lock-metadata","before-active-lock-content-read","after-publication-stage-enumeration","before-publication-stage-validation","after-lock-publication-rename-collision"] as const;
