...
if (manifests.length !== 9 || manifests.some(manifest => manifest.definitions.length !== 1)) throw new Error("Path C requires nine single-definition first-party manifests");
